...
mostrarLinea pos1 pos2 fuel1 fuel2 hp1 hp2 fila
    | fila == 9 = do
        ...
        putStrLn $ "|" ++ replicate pos1 ' ' ++ "0-¨°°¨-0" ++ replicate (40 - pos1) ' ' ++ "***" ++ replicate (pos2 - 42) ' ' ++ "0-¨°°¨-0" ++ replicate (80-pos2) ' ' ++ "|"
    | fila == 8 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 7 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 6 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 5 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 4 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 3 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 2 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 1 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | fila == 0 = putStrLn $ "|" ++ replicate 97 ' ' ++ "|"
    | otherwise = return ()
